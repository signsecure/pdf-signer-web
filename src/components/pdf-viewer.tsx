    ...
    return (
      <div className="flex min-h-screen flex-col bg-gray-50">
        <header className="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 shadow-sm">
          <h1 className="text-lg font-semibold text-gray-800">PDF Signer</h1>
          <UserMenu />
        </header>
        <div className="flex flex-1 items-center justify-center p-4">
          ...
          >
            ...
            <div className="relative h-20 w-20">
              <div className="absolute left-1 top-1 h-full w-full rotate-6 transform rounded-lg bg-gray-100"></div>
              <div className="absolute left-0.5 top-0.5 h-full w-full rotate-3 transform rounded-lg bg-gray-50"></div>
              <div className="relative flex h-full w-full items-center justify-center rounded-lg border-2 border-gray-200 bg-white">
    ...
    <div className="flex h-screen flex-col bg-gray-50">
      <header className="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 shadow-sm">
        <div className="flex items-center gap-4">
          <h1 className="text-xl font-semibold text-gray-800">PDF Signer</h1>
          <button
